...
Le client est synchrone (httpx.Client) — MyQuantStore n'a pas besoin d'async
...
from myquantstore.logging_setup import get_logger, log_api_call, log_pagination_excerpt
